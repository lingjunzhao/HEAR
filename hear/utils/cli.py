...
def get_parser(
    ...
    parser.add_argument(
        ...
        #default="/fs/clip-scratch/lzhao/repos/airbert/bert/bert-base-uncased_tokenizer/",
        type=str,
    ...
    parser.add_argument(
        ...
        default=32,
        type=int,
        help="The size of one batch of training (default: 32)",
    )
    parser.add_argument(
        "--calibration_input_file",
        default="",
        type=str,
        help="Json file with calibration data input",
    )
    parser.add_argument(
        "--test_select_threshold",
        default=False,
        type=boolean_string,
        help="test_select_threshold (default: false)",
    )
    ...
    if training:
        ...
        parser.add_argument(
            ...
            default=False,
            type=boolean_string,
            help="Use calibration dataset during training (default: False)",
        )
        parser.add_argument(
            "--calibration_train",
            default="",
        ...
        parser.add_argument(
            "--calibration_val_seen",
            default="",
            type=str,
            help="Json file with calibration data input",
        )
        parser.add_argument(
            "--calibration_val_unseen",
            default="",
            type=str,
            help="Json file with calibration data input",
        )
